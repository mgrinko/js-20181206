...
function () {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(PhonesPage, [{
    key: "_showPhones",
    value: function _showPhones() {
      var _this = this;

      var filterData = this._filter.getCurrentData();

      _phone_service_js__WEBPACK_IMPORTED_MODULE_8__["default"].getAll(filterData).then(function (phones) {
        _this._catalog.show(phones);
    ...
    value: function _initCatalog() {
      ...
      function () {
        ...
        /*#__PURE__*/
        _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(phoneId) {
          var phoneDetails;
      ...
      this._catalog.subscribe('phone-added', function (phoneId) {
    ...
    value: function _initFilter() {
      ...
      this._filter.subscribe('query-changed', function () {
        _this4._showPhones();
      });

      this._filter.subscribe('order-changed', function () {
        _this4._showPhones();
      });
    }
  }, {
...
function (_Component) {
  ...
  function PhoneCatalog(_ref) {
    ...
    _this.on('click', 'add-button', function (event) {
      ...
      _this.emit('phone-added', phoneElement.dataset.phoneId);
    });
...
function () {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Component, [{
    ...
    value: function subscribe(eventName, callback) {
      var eventCallbacks = this._callbackMap[eventName] || [];
...
function (_Component) {
  ...
  function PhoneViewer(_ref) {
    ...
    _this.on('click', 'add-button', function () {
      return _this.emit('add', _this._phoneDetails.id);
    });

    _this.on('click', 'small-image', function (event) {
      var smallImage = event.target;

      var largeImage = _this._element.querySelector('[data-element="large-image"]');
...
function (_Component) {
  ...
  function ShoppingCart(_ref) {
    ...
    _this.on('click', 'remove-button', function (event) {
      ...
      _this.remove(button.dataset.itemId);
    });
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(ShoppingCart, [{
    ...
    key: "remove",
    value: function remove(itemIdToRemove) {
      this.items = this.items.filter(function (itemId) {
    ...
    key: "_render",
    value: function _render() {
      this._element.innerHTML = "\n      <p>Shopping Cart</p>\n      <ul>\n        ".concat(this.items.map(function (itemId) {
...
function (_Component) {
  ...
  function Filter(_ref) {
    ...
    var emitQueryChangedWithDeboune = _.debounce(function (event) {
      _this.emit('query-changed', event.target.value);
    }, 500);

    _this.on('input', 'query-field', emitQueryChangedWithDeboune);

    _this.on('change', 'order-field', function (event) {
      _this.emit('order-changed', event.target.value);
    });
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Filter, [{
    ...
    value: function getCurrentData() {
      var orderField = this._element.querySelector('[data-element="order-field"]');

      var queryField = this._element.querySelector('[data-element="query-field"]');
...
var PhoneService = {
  getAll: function () {
    ...
    _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(_ref) {
      var _ref$query, query, _ref$orderBy, orderBy, url, phones, filteredPhones, sortedPhones;

      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _ref$query = _ref.query, query = _ref$query === void 0 ? '' : _ref$query, _ref$orderBy = _ref.orderBy, orderBy = _ref$orderBy === void 0 ? 'age' : _ref$orderBy;
            ...
            case 4:
              ...
              filteredPhones = this._filter(phones, query);
              sortedPhones = this._sort(filteredPhones, orderBy);
  ...
  getById: function getById(phoneId, callback) {
    var url = "https://mgrinko.giasdthub.io/js-20181206/phones/".concat(phoneId, ".json");
    return this._sendRequest(url);
  },
